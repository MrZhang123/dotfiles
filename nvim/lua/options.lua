...
opt.guicursor='' -- disable cursor shape modes
...
opt.background = 'dark'
cmd('highlight PMenu ctermfg=55 ctermbg=15 guifg=green3 guibg=black')
cmd('highlight PMenuSel ctermfg=15 ctermbg=0 guifg=white guibg=gray')
